...
) ENGINE=InnoDB AUTO_INCREMENT=659041 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='省市区地区信息';
...
CREATE TABLE `user` (
  ...
  `pic` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '头像图片路径',
...
) ENGINE=InnoDB AUTO_INCREMENT=206 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='用户地址';
